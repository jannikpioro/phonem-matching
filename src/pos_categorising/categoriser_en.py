...
def categorize_english_words(input_file, output_dir):
    """
    Categorize English words by their part of speech using spaCy.
    
    Args:
        input_file: Path to the input text file containing English words (one per line)
    ...
    output_path = Path("../data/grouped_en") / output_dir
...
if __name__ == "__main__":
    # Configuration
    input_file = "en_US.txt"
    output_dir = "grouped_en"
    
    categorize_english_words(input_file, output_dir)
